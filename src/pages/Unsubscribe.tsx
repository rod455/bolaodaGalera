...
export default function Unsubscribe() {
  ...
  async function handleSubmit() {
    if (!motivoSelecionado) {
      setErroForm("Selecione um motivo antes de continuar.");
      return;
    }
    setErroForm("");
    setEnviando(true);
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg p-5 sm:p-8 w-full max-w-md">
        ...
        <div className="flex justify-center mb-6">
          <img
            src="https://dtfqmxmmbbfmfpouzqzt.supabase.co/storage/v1/object/public/iconesapp/BolaoDaGalera%20-%20sem%20fundo.png"
            alt="Bol\u00e3o na Copa"
            className="w-14 h-14"
          />
        </div>
          ...
          <>
            ...
            {motivoSelecionado === "Outro motivo" && (
              <textarea
                ...
                className="w-full border-2 border-gray-200 rounded-xl p-3 text-sm text-gray-700 resize-none min-h-[80px] mb-4 focus:outline-none focus:border-green-600"
              />
            )}
