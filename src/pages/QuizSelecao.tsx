...
import { ArrowLeft, Share2, Loader2, ChevronRight, Copy, Check, Crown, Lock } from "lucide-react";
...
// Quizzes futuros (Em Breve) - exibidos na intro
const FUTURE_QUIZZES = [
  { emoji: "🎯", title: "Qual tipo de palpiteiro você é?", desc: "Analista, sortudo, torcedor ou o social?" },
  { emoji: "🏟️", title: "Qual posição você joga na vida?", desc: "Atacante, goleiro, meia ou zagueiro?" },
  { emoji: "🌎", title: "Em qual país-sede você estaria?", desc: "EUA, México ou Canadá?" },
];
...
const QuizSelecao = () => {
  ...
  // OLD HUB BLOCK REMOVED — now in Quiz.tsx
  if (false) {
